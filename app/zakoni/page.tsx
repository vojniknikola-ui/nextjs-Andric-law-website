...
import { ScrollText, PenSquare, Sparkles } from "lucide-react";

export const metadata: Metadata = {
  title: "Zakoni i članci | Andrić Law",
  description: "Digitalni pregled zakona i autorskih članaka u istom vizuelnom ritmu. Filtrirajte, pretražite i otvorite propise ili analize.",
  openGraph: {
    title: "Zakoni i članci | Andrić Law",
    description: "Brza lista propisa i stručnih tekstova sa filtriranjem i pretragom.",
    type: "website",
  },
};
      ...
      <section className="border-b border-white/10 bg-slate-900/70">
        <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-12 sm:px-6 lg:px-8">
          ...
          <p className="max-w-3xl text-slate-200">
            Jedinstvena lista propisa i autorskih tekstova. Jednostavno filtriranje po tipu i tagovima, bez dodatnih ekrana.
          </p>
